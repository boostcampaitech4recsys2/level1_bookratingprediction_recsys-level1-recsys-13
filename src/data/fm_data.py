...
def fm_data_load(args):
    ...
    idx, context_train, context_test = process_fm_data(users, books, train, test)
    field_dims = np.array([len(user2idx), len(isbn2idx), 6, len(idx['loc_country2idx']),
