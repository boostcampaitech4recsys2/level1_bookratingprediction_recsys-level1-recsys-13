...
def process_ncf_data(users, books, ratings1, ratings2):
    ...
    train_df['year_of_publication'] = train_df['year_of_publication'].map(year_of_publication2idx)
    test_df['category'] = test_df['category'].map(category2idx)
    test_df['publisher'] = test_df['publisher'].map(publisher2idx)
    test_df['language'] = test_df['language'].map(language2idx)
    test_df['book_author'] = test_df['book_author'].map(author2idx)
    test_df['year_of_publication'] = test_df['year_of_publication'].map(year_of_publication2idx)
    ...
    idx = {
        ...
        "year_of_publication":year_of_publication2idx,
    }
